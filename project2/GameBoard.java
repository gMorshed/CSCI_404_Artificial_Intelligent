...
public class GameBoard 
{
     ...
     * 
     * 
     * count the number of threes that has potential to be four as in  1110 or 0222 in any combination.
     * checks in all possible direction that can generate a valid score: such as vertically, horizontally, and diagonally
     * this function has been adapted from research found for evaluation function. See README and evaluation function for link
     * @param player
     * @return int
     */
...
/**
 * count the number of twos for a player in the board that could result in a score. this is hectic
 * this function has been adapted from research found for evaluation function. See README and evaluation function for link
 * @param player
 * @return int
 */
